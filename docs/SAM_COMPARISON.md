...
python3 research/code/baseline_loio_for_sam.py
python3 research/code/generate_sam_figures.py
```
...
*Generated by `research/code/write_sam_report.py` from the result JSONs — every number above is read from measurement output, not transcribed.*
