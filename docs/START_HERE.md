...
| SAM + 17 hybrid alone | 0.786 | 0.747 0.780 0.814 0.820 0.770 |
| **mean-probability ensemble** | **0.811** | 0.778 0.821 0.830 0.831 0.798 |

Read from the deployed model's own gate record (`thincore_v5`, stamp `20260824_225236`,
`heldout.per_fold`) rather than typed in: the five ensemble folds average to 0.8113 with sd
