...
- **IoU 0.821, recall 0.914** on the reference ground-truth images under
  leave-one-image-out, so train and test never share an image.
- **100% of large flaws detected** — everything over 20 k px, which is 96.2% of all crack area.
- **0.076–0.106% of area** marked as crack on specimens confirmed crack-free.
  MIL-HDBK-1823A treats ≤1% probability of false calls as the NDT yardstick.
